<template>
  <ProfilePageTemplate
    ...
    cover-gradient="bg-gradient-to-r from-emerald-600 via-teal-600 to-green-600"
    :user-data="userData"
  ...
  >
    <template #profile-images>
      <div class="flex gap-4">
        <div class="relative group">
          <div class="w-32 h-32 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white text-4xl font-bold border-4 border-slate-800 shadow-xl overflow-hidden">
          ...
          <button
            ...
            class="absolute bottom-2 right-2 p-2 rounded-lg bg-emerald-600 text-white hover:bg-emerald-700 transition-colors shadow-lg"
          >
    ...
    <template #edit-button>
      <button
        ...
        :class="['flex items-center gap-2 px-4 py-2 rounded-lg font-semibold transition-all', isEditing ? 'bg-gradient-to-r from-emerald-600 to-teal-600 text-white shadow-lg shadow-emerald-500/30' : 'bg-slate-700 text-slate-300 hover:bg-slate-600']"
      >
    ...
    <template #upgrade-button>
      <button
        class="w-full mt-4 px-4 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all"
...
import { Mail, Camera, Edit2, Save, Users } from 'lucide-vue-next'
