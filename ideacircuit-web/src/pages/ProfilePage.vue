<template>
  <ProfilePageTemplate
    ...
    cover-gradient="bg-gradient-to-r from-purple-600 via-pink-600 to-fuchsia-600"
    :user-data="userData"
  ...
  >
    <template #profile-images>
      <div class="flex gap-4">
        <div class="relative group">
          <div class="w-32 h-32 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center text-white text-4xl font-bold border-4 border-slate-800 shadow-xl overflow-hidden">
          ...
          <button
            ...
            class="absolute bottom-2 right-2 p-2 rounded-lg bg-purple-600 text-white hover:bg-purple-700 transition-colors shadow-lg"
          >
    ...
    <template #edit-button>
      <button
        ...
        :class="['flex items-center gap-2 px-4 py-2 rounded-lg font-semibold transition-all', isEditing ? 'bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg shadow-purple-500/30' : 'bg-slate-700 text-slate-300 hover:bg-slate-600']"
      >
...
import { Mail, Camera, Edit2, Save, Sparkles } from 'lucide-vue-next'
