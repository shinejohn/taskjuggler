        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 shadow-2xl">
                ...
                <form @submit.prevent="handleSubmit" class="space-y-5">
                    ...
                    <!-- Name -->
                    <div>
                        <label for="name" class="block text-sm font-medium text-purple-200 mb-1.5">Full Name</label>
                        <input
                            id="name"
                            v-model="name"
                            type="text"
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <label for="password_confirm" class="block text-sm font-medium text-purple-200 mb-1.5">Confirm Password</label>
                        <input
                            id="password_confirm"
