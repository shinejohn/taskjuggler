    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li>
              <a href="#features" class="text-gray-600 hover:text-blue-600">
                Features
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#use-cases" class="text-gray-600 hover:text-blue-600">
                Use Cases
              </a>
            </li>
            <li>
              <a href="#testimonials" class="text-gray-600 hover:text-blue-600">
                Testimonials
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul class="space-y-3">
            ...
            <li>
              <a href="#" class="text-gray-600 hover:text-blue-600">API</a>
            </li>
          </ul>
        </div>
        <div>
      ...
      <div class="border-t border-gray-200 mt-12 pt-8 text-center">
        <p class="text-gray-500 text-sm">
          &copy; {{ new Date().getFullYear() }} Task Juggler. All rights
          reserved.
        </p>
      </div>
    </div>
...
// No props needed for the basic footer
</script>
