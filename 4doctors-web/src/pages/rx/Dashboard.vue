<template>
  <div class="space-y-6">
     <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
        <div>
        ...
        <div class="flex flex-wrap items-center gap-3">
             ...
             <router-link to="/rx/new" class="px-4 py-2 bg-slate-900 text-white rounded-lg text-sm font-bold hover:bg-slate-800 shadow-lg flex items-center gap-2">
...
import { ref } from 'vue';
import { Pill, Plus, Wifi, MapPin, Search } from 'lucide-vue-next';
