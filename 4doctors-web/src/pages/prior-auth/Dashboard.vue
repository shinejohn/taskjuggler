<template>
  <div class="space-y-6">
    <header class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
        <div>
        ...
        <div class="flex flex-wrap items-center gap-3">
             ...
             <div class="relative">
                 ...
                 <input 
                     v-model="searchQuery"
                     type="text" 
                     placeholder="Search auth ID, patient..." 
                     class="pl-9 pr-4 py-2 w-56 bg-slate-50 border border-slate-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-blue-500"
                 >
             </div>
             <select v-model="statusFilter" class="px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm">
             ...
             <div class="px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg flex items-center gap-2">
                ...
                <span class="text-sm font-bold text-slate-700">Auto-Approval: 84%</span>
             </div>
             <router-link to="/prior-auth/new" class="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-bold hover:bg-blue-700 shadow-lg flex items-center gap-2">
...
import { 
    ...
    Pill, Microscope, FileText, Search 
