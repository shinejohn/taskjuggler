<template>
  ...
  <div v-else class="min-h-screen bg-slate-50 font-sans">
    <header class="bg-white border-b border-slate-200 h-16 flex items-center px-6">
      <div class="flex items-center gap-2">
        ...
        <span class="text-xl font-bold text-slate-900">4healthcare</span>
      </div>
    ...
    <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <h1 class="text-2xl font-bold text-slate-900 mb-6">
        Good Morning, {{ authStore.isNurse ? 'Nurse' : (profile?.specialty || 'Doctor') }}
      </h1>
