...
return [
    // Disabled by default so the SDK never tries to reach a non-existent
    // local agent socket. Set NIGHTWATCH_ENABLED=true on environments where
    // the `php artisan nightwatch:agent` process is running and a token is set.
