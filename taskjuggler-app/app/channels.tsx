    ...
    >
      <View className="p-4">
        <View className="flex-row justify-between items-center mb-4">
          ...
          <View className="flex-row gap-2">
            <TouchableOpacity
              ...
              onPress={() => Alert.alert('Info', 'Add phone channel coming soon')}
            >
              <Text className="text-white text-xs font-semibold">+ Phone</Text>
            </TouchableOpacity>
            <TouchableOpacity
              className="bg-green-600 rounded px-3 py-2"
              onPress={() => Alert.alert('Info', 'Add email channel coming soon')}
            >
        ...
        {loading && channels.length === 0 ? (
          ...
          <View className="py-8">
            <Text className="text-gray-500 text-center">No channels configured yet</Text>
          </View>
        ) : (
              ...
              <View key={channel.id} className="bg-white rounded-lg p-4 shadow-sm">
                ...
                <View className="flex-row gap-2 mt-3">
                  <TouchableOpacity
                    ...
                    onPress={() => Alert.alert('Info', 'Edit channel coming soon')}
                  >
