<template>
  <ProfilePageTemplate
    ...
    cover-gradient="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600"
    :user-data="userData"
  ...
  >
    <template #profile-images>
      <div class="flex gap-4">
        <div class="relative group">
          <div class="w-32 h-32 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-4xl font-bold border-4 border-slate-800 shadow-xl overflow-hidden">
          ...
          <button
            ...
            class="absolute bottom-2 right-2 p-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors shadow-lg"
          >
    ...
    <template #edit-button>
      <button
        ...
        :class="['flex items-center gap-2 px-4 py-2 rounded-lg font-semibold transition-all', isEditing ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg shadow-blue-500/30' : 'bg-slate-700 text-slate-300 hover:bg-slate-600']"
      >
      ...
      <div class="space-y-6">
        <div>
          ...
          <input
            ...
            type="text"
            class="w-full px-4 py-3 bg-slate-900/50 border-2 border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 transition-colors"
          />
    ...
    <template #upgrade-button>
      <button
        class="w-full mt-4 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all"
...
import { Mail, Camera, Edit2, Save, CheckSquare } from 'lucide-vue-next'
