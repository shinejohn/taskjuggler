  ...
  >
    ...
    <template #checkout-button>
      <button
        ...
        class="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 transition-all"
      >
        Contact Support
...
import { ArrowRight, Check, CheckSquare } from 'lucide-vue-next'
...
const currentPlanDescription = computed(() => {
  switch (currentPlanName.value) {
    ...
    case 'business':
      return 'Advanced collaboration and team management.'
    case 'enterprise':
      return 'Custom limits, SLA, and dedicated support.'
    default:
      return 'Basic access to core Task Juggler features.'
  }
})

function handleContactSupport() {
  window.location.href = 'mailto:support@taskjuggler.com?subject=Subscription%20Change'
}
</script>
